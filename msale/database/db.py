...
USERNAME = "username" #postgres database login username
PASSWORD = "password" #postgres database login password
...
class CreateDb:
    ...
    def create_database(self):
        try:
            con = psycopg2.connect(host = "localhost", database = "postgres", password = PASSWORD, user= USERNAME) 
